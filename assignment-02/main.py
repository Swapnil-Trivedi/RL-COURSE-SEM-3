...
#    - random_oracle.pyc: The function to generate your unique assignment map.
#
# 2. Run this script from your terminal: python main.py
#
# 3. You will be prompted to enter your Student ID to generate your unique grid.
#
# What this script does:
# - Sets up a unique GridWorld environment based on your student ID.
...
if __name__ == "__main__":
    ...
    # The 'random oracle' function takes your student ID to generate a unique but
    # consistent set of start, goal, and obstacle positions. This ensures that every
    # student gets a different problem, but your own problem stays the same every
    # time you run the code, which is crucial for debugging and consistent results.
    student_id = int(input("Enter your Student ID (last 5 digits of your SR No.) to generate your unique GridWorld: "))
    start, goal, obstacles = get_start_goal_and_obstacle_states(student_id)
    ...
    vi_agent = ValueIterationAgent(env, gamma=gamma_vi)
    ...
    pi_agent = PolicyIterationAgent(env, gamma=gamma_pi)
